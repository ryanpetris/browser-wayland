...
| `0x94` | Cam | One VP8 frame of the browser's webcam (720p, 30 fps, 2 Mbit/s, a keyframe every 60 frames), played into the loopback camera as it arrives. Controlling session only; dropped without `--webcam`. |
