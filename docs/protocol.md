...
| `0x0E` | Fragment | On the data channel only: `u32 id` `u16 index` `u16 count` then a piece of one message (a video frame; 16 kB pieces), reassembled by id. A frame missing a piece is dropped, and the seq gap gets a keyframe. |
