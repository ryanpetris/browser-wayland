...
| Screenshots for models | `snapshot` and `screenshot` default to native dimensions. Supply one of `width`, `height`, or `percentage` for previews; [limits and legacy scale migration](desktop-api.md#screenshot-sizing). |
